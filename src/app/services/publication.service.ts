...
export class PublicationService {
  ...
  updatePublication(
    ...
    return this.http.put(`${this.apiUrl}/updatePublication/${id}`, formData, {
      headers,
    });
  }
  deletePublicationFile(id: number) {
    ...
    return this.http.delete(`http://localhost:8082/publications/delete/${id}`, {
      headers,
    });
  }
  updateComment(commentId: number, commentaire: any): Observable<any> {
    ...
    return this.http.put(`${this.baseUrl}/${commentId}`, commentaire, {
      headers,
    });
  }
  ...
  updateCommentaire(commentId: number, payload: any) {
    ...
    return this.http.put(
      `http://localhost:8082/commentaires/${commentId}`,
      payload,
      { headers }
    );
  }
  ...
  addCommentaire(publicationId: number, commentaire: any): Observable<any> {
    return this.http.post<any>(
      `${this.baseUrl}/${publicationId}/commentaire`,
      commentaire
    );
  }
  getCommentaires(publicationId: number) {
    ...
    return this.http.get<Commentaire[]>(
      `http://localhost:8082/publications/${publicationId}/commentaires`,
      { headers }
    );
  }
  updateReactionCommentaire(
    ...
    return this.http.put(
      `http://localhost:8082/commentaires/${commentaireId}/reaction/increment`,
      { reaction },
      { headers }
    );
  }
  updateReactionCommentaires(
    commentId: number,
    reaction: string,
    email: string
  ): Observable<any> {
    ...
    return this.http.post(
      `http://localhost:8082/commentaires/commentaires/${commentId}/react`,
      {
        reaction,
        email,
      },
  ...
  getCommentReactionCount(commentId: number) {
    ...
    return this.http.get<{ [emoji: string]: number }>(
      `http://localhost:8082/commentaires/${commentId}/reactions`,
      { headers }
    );
  }
